...
@sink(type="restql-call", restql.name="update_issue_counts")
define stream RestQlUpdateIssueCount(fault string, count int);

@sink(type="restql-call", restql.name="update_area_issue_counts")
define stream RestQlUpdateAreaIssueCount(city string, count int);

@sink(type="restql-call", restql.name="update_vehicle_issue_counts")
define stream RestQlUpdateVehicleIssueCount(asset string, count int, total_cost int);
